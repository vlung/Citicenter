...
using System.Text;
    ...
    class ListWriter<T>
    {
        ...
        public void WriteList(FileStream stream, StorageFreeSpaceManager freeSpaceMgr, List<T> list, out List<int> pages)
        {
            // create the pages
        ...
        private int WriteTopPage(FileStream stream, StorageFreeSpaceManager mgr, int lastPageAddress)
        {
            // update the header
